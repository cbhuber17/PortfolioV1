...
// Require 36 for effective periodic table display
const technologies = [
  {
    short: "Ht",
    name: "HTML 5",
...
const experiences = [
  ...
  },
  {
    ...
    titlevn: "Kỹ Sư Xác Minh Quan Trọng Về An Toàn",
    company_name: "Hexagon",
    icon: hexagon,
    iconBg: "#383E56",
    date: "January 2012 - April 2023",
    datevn: "Tháng 1, 2012 - Tháng 4, 2023",
    points: [
    ...
    pointsvn: [
      "Kiến trúc và thực hiện các thử nghiệm thủ công/tự động bằng cách sử dụng python và C++, tuân theo các tiêu chuẩn hàng không (DO-178B) và các phương pháp hay nhất ISTQB.",
      "Dẫn dắt một nhóm và cố vấn cho các thành viên mới; thực hiện đánh giá ngang hàng chi tiết.",
      "Cải thiện chất lượng sản phẩm bằng cách nêu ra 25 lỗi.",
      "Thiết kế các thiết lập thử nghiệm hiệu quả giúp giảm chi phí kỹ thuật cho dự án (lên tới 10%).",
    ],
  },
  {
    ...
    datevn: "Tháng 6, 2010 - Tháng 1, 2012",
    points: [
